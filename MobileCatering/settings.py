"""
Django settings for MobileCatering project.
...
SECRET_KEY = 'django-insecure-(xv-i6wdshryh41bnwevw^kixi*db(*(bqu@ayzw=9a93_&p_3'
...
ROOT_URLCONF = 'MobileCatering.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "orders.context_processors.user_permissions",  # <-- permission setting
            ],
        },
    },
]

WSGI_APPLICATION = 'MobileCatering.wsgi.application'
